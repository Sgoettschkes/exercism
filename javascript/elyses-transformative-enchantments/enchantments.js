...
export function sandwichTrick(deck) {
  const firstElement = deck.splice(0, 1)[0];
  const lastElement = deck.splice(-1, 1)[0];
  deck.splice(deck.length / 2, 0, firstElement);
  deck.splice(deck.length / 2, 0, lastElement);
